...
--Q1. What is the total revenue generated by male vs fimale customers.

select gender,sum(purchase_amount) as revenue from customer group by gender;

--Q2. Which customers used a disount but still spent more than the average purchase amount.
...
from customer group by subscription_status order by total_revenue,avg_spend;
